...
/** Resets values (including those calculated with other css variables) using DEFAULT_THEME */
export const resetTheme = (theme: DatepickerThemeStrings) => {
    ...
    retTheme["--on-neutral-light"] = theme["--on-neutral-light"] ? theme["--on-neutral-light"]
        : theme["--on-background"] ? theme["--on-background"]
            : DEFAULT_THEME_STRINGS["--on-neutral-light"];
    retTheme["--on-neutral"] = theme["--on-neutral"] ? theme["--on-neutral"]
        : theme["--background"] ? theme["--background"]
            : DEFAULT_THEME_STRINGS["--on-neutral"];

    retTheme["--weekday-row"] = theme["--weekday-row"] ? theme["--weekday-row"]
        : theme["--background"] ? theme["--background"]
            : DEFAULT_THEME_STRINGS["--weekday-row"];
    retTheme["--on-weekday-row"] = theme["--on-weekday-row"] ? theme["--on-weekday-row"]
        : theme["--neutral"] ? theme["--neutral"]
            : DEFAULT_THEME_STRINGS["--on-weekday-row"];

    retTheme["--divider"] = theme["--divider"] ? theme["--divider"]
        : theme["--neutral-light"] ? theme["--neutral-light"]
            : DEFAULT_THEME_STRINGS["--divider"];
    retTheme["--label-text"] = theme["--label-text"] ? theme["--label-text"]
    ...
    retTheme["--on-button"] = theme["--on-button"] ? theme["--on-button"]
        : theme["--neutral-dark"] ? theme["--neutral-dark"]
    ...
    retTheme["--hover"] = theme["--hover"] ? theme["--hover"]
        : theme["--neutral"] ? theme["--neutral"]
            : DEFAULT_THEME_STRINGS["--hover"];
    retTheme["--on-hover"] = theme["--on-hover"] ? theme["--on-hover"]
        : theme["--on-neutral"] ? theme["--on-neutral"]
            : DEFAULT_THEME_STRINGS["--on-hover"];
    retTheme["--hover-range"] = theme["--hover-range"] ? theme["--hover-range"]
        : theme["--neutral-light"] ? theme["--neutral-light"]
            : DEFAULT_THEME_STRINGS["--hover-range"];
    retTheme["--on-hover-range"] = theme["--on-hover-range"] ? theme["--on-hover-range"]
        : theme["--on-neutral-light"] ? theme["--on-neutral-light"]
            : DEFAULT_THEME_STRINGS["--on-hover-range"];

    retTheme["--today"] = theme["--today"] ? theme["--today"]
        : theme["--neutral"] ? theme["--neutral"]
            : DEFAULT_THEME_STRINGS["--today"];

    retTheme["--disabled"] = theme["--disabled"] ? theme["--disabled"] : DEFAULT_THEME_STRINGS["--disabled"];
    retTheme["--on-disabled"] = theme["--on-disabled"] ? theme["--on-disabled"]
        : theme["--neutral"] ? theme["--neutral"]
